...
ActiveRecord::Schema.define(version: 2019_03_28_184332) do
  ...
  create_table "event_infos", force: :cascade do |t|
    ...
    t.index ["venue_id"], name: "index_event_infos_on_venue_id"
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.index ["event_info_id"], name: "index_orders_on_event_info_id"
  ...
  create_table "ticket_types", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_info_id"], name: "index_ticket_types_on_event_info_id"
  end
